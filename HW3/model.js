function buildHead2(WW, HH, DD) {
 ...
 vertices.push(-WW/2,HH/2,-DD/2, -WW/2,HH/2,DD/2, WW/2,HH/2,DD/2, WW/2,HH/2,-DD/2 ); // 0,3,2,1
  indices.push(0+16,1+16,2+16, 0+16,2+16,3+16);
	uvs.push (a.u/UU,a.v/VV, e.u/UU,e.v/VV, f.u/UU,f.v/VV, b.u/UU,b.v/VV); // a,e,f,b
	
	vertices.push(-WW/2,-HH/2,-DD/2, -WW/2,-HH/2,DD/2, WW/2,-HH/2,DD/2, WW/2,-HH/2,-DD/2 ); // 0,3,2,1
  indices.push(0+16+4,1+16+4,2+16+4, 0+16+4,2+16+4,3+16+4);
...
// PZ
 ...
 vertices.push(-WW/2,HH/2,-DD/2, -WW/2,HH/2,DD/2, WW/2,HH/2,DD/2, WW/2,HH/2,-DD/2 ); // 0,3,2,1
  ...
  let foot = new THREE.Mesh (geometry, new THREE.MeshBasicMaterial({map: texture, side:THREE.DoubleSide}));
	group_foot.add(foot);
	foot.position.y = -HH/2;
	return group_foot;
}
function leg2(WW, HH, DD) {
  ...
  var a = {u: ww+10*ww, v:hh+ww};
  var b = {u: 2*ww+10*ww, v:hh+ww};
  var c = {u: 3*ww+10*ww, v:hh+ww};
  var d = {u: 10*ww, v:hh};
  var e = {u: ww+10*ww, v:hh};
  var f = {u: 2*ww+10*ww, v:hh};
  var g = {u: 3*ww+10*ww, v:hh};
  var h = {u: 4*ww+10*ww, v:hh};
  var i = {u: 10*ww, v:0};
  var j = {u: ww+10*ww, v:0};
  var k = {u: 2*ww+10*ww, v:0};
  var l = {u: 3*ww+10*ww, v:0};
  var m = {u: 4*ww+10*ww, v:0};
...
// PZ
 ...
 vertices.push(-WW/2,HH/2,-DD/2, -WW/2,HH/2,DD/2, WW/2,HH/2,DD/2, WW/2,HH/2,-DD/2 ); // 0,3,2,1
  ...
  let leg2 = new THREE.Mesh (geometry, new THREE.MeshBasicMaterial({map: texture, side:THREE.DoubleSide}));
	group_hand.add(leg2);
	leg2.position.y = -HH/2;
	return group_hand;
}
